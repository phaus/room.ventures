...
room.venture is a static homepage for hotel room reviews, built with Hugo. Content is generated by an AI agent that processes dumped photos, extracts EXIF metadata, analyzes images, and produces static Markdown review pages.
