...
[camera]
model = "iPhone 6"
date_taken = 2014-12-26T00:00:00+01:00
...
- **Style:** Dated business hotel
- **Condition:** Worn — furniture and color scheme clearly from a previous era, though structurally intact
- **Luxury Level:** Mid-range — spacious suite layout with kitchenette elevates it above budget tier
- **Cleanliness:** Good — linens appear fresh, surfaces tidy
- **Notable Features:** Kitchenette with granite counter and bar seating, separate living area, generous floor space
- **Drawbacks:** Red carpet and yellow walls feel outdated, dark and heavy atmosphere, twin beds rather than a double, decor lacks any character or warmth
